...
MetadataCatalog.get("or_matseg_sem_panoptic_train").set(
    stuff_colors=PALETTE,
)

MetadataCatalog.get("or_matseg_sem_panoptic_val").set(
    stuff_colors=PALETTE,
)


def load_or_matseg_sem_panoptic_json(json_file, image_dir, gt_dir, meta):
    """
    Args:
...
def register_or_matseg_sem_panoptic(
    ...
    DatasetCatalog.register(
        panoptic_name,
        lambda: load_or_matseg_sem_panoptic_json(
...
_PREDEFINED_SPLITS_OR_MATSEG_sem_PANOPTIC = {
    "or_matseg_sem_panoptic_train": (
        "OpenRooms_public",
        "OpenRooms_public/im_matseg_sem_pan_seg_rgb",
        # "OpenRooms_public/im_matseg_sem_pan_seg_rgb_train.json",
        "OpenRooms_public/im_matseg_sem_pan_seg_rgb_val.json",
    ), 
    "or_matseg_sem_panoptic_val": (
        "OpenRooms_public",
        "OpenRooms_public/im_matseg_sem_pan_seg_rgb",
        "OpenRooms_public/im_matseg_sem_pan_seg_rgb_val.json",
