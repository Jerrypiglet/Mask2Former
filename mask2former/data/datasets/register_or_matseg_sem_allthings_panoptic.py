...
MetadataCatalog.get("or_matseg_sem_allthings_panoptic_train").set(
    stuff_colors=PALETTE,
)

MetadataCatalog.get("or_matseg_sem_allthings_panoptic_val").set(
    stuff_colors=PALETTE,
)


def load_or_matseg_sem_allthings_panoptic_json(json_file, image_dir, gt_dir, meta):
    """
    Args:
...
def register_or_matseg_sem_panoptic(
    ...
    Args:
        name (str): the name that identifies a dataset,
            e.g. "or_matseg_sem_panoptic_train"
    ...
    DatasetCatalog.register(
        panoptic_name,
        lambda: load_or_matseg_sem_allthings_panoptic_json(
...
_PREDEFINED_SPLITS_OR_MATSEG_sem_PANOPTIC = {
    "or_matseg_sem_allthings_panoptic_train": (
        "OpenRooms_public",
        "OpenRooms_public/im_matseg_sem_pan_seg_rgb",
        # "OpenRooms_public/im_matseg_sem_pan_seg_rgb_train.json",
        "OpenRooms_public/im_matseg_sem_allthings_pan_seg_rgb_val.json",
    ), 
    "or_matseg_sem_allthings_panoptic_val": (
        "OpenRooms_public",
        "OpenRooms_public/im_matseg_sem_pan_seg_rgb",
        "OpenRooms_public/im_matseg_sem_allthings_pan_seg_rgb_val.json",
...
def register_all_or_matseg_sem_panoptic(root):
    metadata = get_metadata()
    for (
        prefix,
        (image_root, panoptic_root, panoptic_json),
    ) in _PREDEFINED_SPLITS_OR_MATSEG_sem_PANOPTIC.items():
        # The "standard" version of COCO panoptic segmentation dataset,
        # e.g. used by Panoptic-DeepLab
        register_or_matseg_sem_panoptic(
            prefix,
            metadata,
